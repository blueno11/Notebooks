...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
...
_s(Header, "Q87HVOE/OlcNOFIQoG/Bcq4PnJI=", false, function() {
    return [
...
"[project]/src/app/notebook/notebook-active/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NotebookPage() {
    ...
    const [reviewWords, setReviewWords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [sleepWords, setSleepWords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [levelWords, setLevelWords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleSearch = async ()=>{
        ...
        try {
            ...
            setSelectedWords(results.filter((word)=>word.type === 'review').map((word)=>word.word));
            setLevelWords([]);
        } catch (error) {
    ...
    const handleLevelClick = async (level)=>{
        ...
        setSelectedWords([]);
        try {
            const res = await fetch(`http://localhost:4000/vocabulary/getWordsByLevel?userId=${user.user.userInfo.userId}&level=${level}`, {
                credentials: 'include'
            });
            if (!res.ok) {
    ...
    const handleWordSelection = (word)=>{
        setSelectedWords((prev)=>prev.includes(word) ? prev.filter((w)=>w !== word) : [
                ...prev,
                word
            ]);
    };
    const handleSave = async ()=>{
        ...
        const sleepWords = currentWords.map((w)=>w.word).filter((w)=>!selectedWords.includes(w));
        setIsLoading(true);
        setError(null);
        try {
            ...
            if (currentLevel) {
                const res = await fetch(`http://localhost:4000/vocabulary/getWordsByLevel?userId=${user.user.userInfo.userId}&level=${currentLevel}`, {
                    credentials: 'include'
                });
                if (res.ok) {
                    const results = await res.json();
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            5
                                ...
                                children: level === 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex",
                                    children: [
                                        1,
                                        2,
                                        ...
                                        5
                                            ...
                                            className: "h-2 w-2 rounded-full bg-green-500 mx-0.5"
                                        }, dot, false, {
                                            fileName: "[project]/src/app/notebook/notebook-active/page.tsx",
                                            lineNumber: 222,
                                            columnNumber: 21
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                disabled: isLoading,
                                children: isLoading ? 'Đang tìm...' : 'Tìm kiếm'
                            }, void 0, false, {
                                fileName: "[project]/src/app/notebook/notebook-active/page.tsx",
                                lineNumber: 239,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                onClick: handleSave,
                                disabled: isLoading,
                                children: isLoading ? 'Đang lưu...' : 'Lưu'
                            }, void 0, false, {
                                fileName: "[project]/src/app/notebook/notebook-active/page.tsx",
                                lineNumber: 247,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-full max-w-xl mt-4 px-4",
                        children: [
                            ...
                            !isLoading && currentLevel && levelWords.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    ...
                                    levelWords.map((word, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            }, void 0, true) : !isLoading && currentLevel && levelWords.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-gray-600",
                                children: [
                                    "Không có từ vựng nào ở cấp độ ",
                                    currentLevel,
                                    "."
                                ]
                            }, void 0, true, {
                                ...
                                lineNumber: 282,
                                columnNumber: 13
                            }, this) : !isLoading && searchResults.length > 0 ? searchResults.map((word, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mb-6 flex items-start",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            type: "checkbox",
                                    ...
                                    lineNumber: 285,
                                    columnNumber: 15
                                }, this)) : !isLoading && search && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-gray-600",
                                children: [
                                    'Không tìm thấy từ "',
                                    search,
...
_s(NotebookPage, "89WVtljXtOB6fOUfWW2RSXZZBsY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = NotebookPage;
var _c;
__turbopack_context__.k.register(_c, "NotebookPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_ea394410._.js.map